...
A user reported something specific: on their iPhone, opening the Contact page made the nav's typewriter animation stutter and the mobile menu slow to open — but only on that page, and only until they navigated away.
