...
const HomeIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" strokeWidth={2} stroke="currentColor" aria-hidden className={className} {...props}>
  ...
  return (
    <>
            ...
            */}
            ...
            <div>
              ...
              <TypingAnimation
                ...
                texts={["Full-Stack Engineer", "AI Builder", "Product Thinker"]}
              />
            </div>
          </div>
          <button onClick={() => setMenuOpen(true)} className="p-2 rounded-lg text-zinc-400 hover:bg-zinc-800/50 transition-colors" aria-label="Open menu">
      ...
      <aside className={s.desktopSidebar}>
          ...
          {socials.map(({ label, href, svgPath }) => (
            <li key={label}>
              <a href={href} target="_blank" rel="noopener noreferrer" className={s.socialItem}>
                <svg viewBox="0 0 24 24" fill="currentColor" className={s.socialIcon} aria-hidden>
                  <path d={svgPath} />
                </svg>
        ...
        <p className={s.footerText}>© 2025 Etinosa</p>
      </aside>
      ...
      */}
      ...
      >
        <div className={`${s.mobileOverlayBg} ${menuOpen ? s.mobileOverlayBgVisible : s.mobileOverlayBgHidden}`} />
        <div
          ...
          <div className={s.mobileSidebarHeader}>
            <div className={s.mobileHeaderInner}>
              <div className={s.mobileHeaderAvatarContainer}>
                ...
                <div>
                  <p className={s.mobileName}>Etinosa</p>
                  <p className={s.mobileTyping}>Full-Stack Engineer</p>
                </div>
              </div>
              <button onClick={() => setMenuOpen(false)} className={s.mobileCloseButton} aria-label="Close menu">
                ...
                {socials.map(({ label, href, svgPath }) => (
                  <li key={label}>
                    <a href={href} target="_blank" rel="noopener noreferrer" className={s.mobileSocialItem}>
                      <svg viewBox="0 0 24 24" fill="currentColor" className={s.mobileSocialIcon} aria-hidden>
                        <path d={svgPath} />
                      </svg>
